...
set_property DRIVE 16 [get_ports {nand_data[4]}]
set_property DRIVE 16 [get_ports {nand_data[2]}]
set_property DRIVE 16 [get_ports {nand_data[1]}]
set_property DRIVE 16 [get_ports {nand_data[0]}]
set_property DRIVE 16 [get_ports nand_ale]
set_property DRIVE 16 [get_ports nand_cle]
set_property DRIVE 16 [get_ports nand_re]
set_property DRIVE 16 [get_ports nand_we]
