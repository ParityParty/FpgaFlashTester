...
set_property IOSTANDARD LVCMOS33 [get_ports nand_nce]
set_property IOSTANDARD LVCMOS33 [get_ports nand_nre]
set_property IOSTANDARD LVCMOS33 [get_ports nand_nwe]
set_property IOSTANDARD LVCMOS33 [get_ports nand_nwp]
set_property IOSTANDARD LVCMOS33 [get_ports nand_rnb]
set_property PACKAGE_PIN W11 [get_ports nand_nre]
set_property PACKAGE_PIN W12 [get_ports nand_nce]
set_property PACKAGE_PIN AB15 [get_ports nand_cle]
set_property PACKAGE_PIN AA13 [get_ports nand_ale]
set_property PACKAGE_PIN Y13 [get_ports nand_nwe]
set_property PACKAGE_PIN AB13 [get_ports nand_nwp]
set_property IOSTANDARD LVCMOS33 [get_ports {nand_data[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {nand_data[6]}]
set_property PACKAGE_PIN AB14 [get_ports {nand_data[0]}]
set_property PACKAGE_PIN AB9 [get_ports {nand_data[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {nand_data[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {nand_data[0]}]
set_property PACKAGE_PIN W14 [get_ports {nand_data[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {nand_data[2]}]
set_property PACKAGE_PIN W13 [get_ports {nand_data[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {nand_data[3]}]
set_property PACKAGE_PIN Y14 [get_ports {nand_data[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {nand_data[4]}]
set_property PACKAGE_PIN AA12 [get_ports {nand_data[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {nand_data[5]}]
set_property PACKAGE_PIN Y9 [get_ports {nand_data[6]}]
set_property PACKAGE_PIN AA8 [get_ports {nand_data[7]}]
set_property PACKAGE_PIN AD14 [get_ports nand_rnb]
set_property PULLTYPE PULLUP [get_ports nand_rnb]

set_property IOSTANDARD LVCMOS12 [get_ports {nand_data[14]}]
set_property IOSTANDARD LVCMOS12 [get_ports {nand_data[13]}]
set_property IOSTANDARD LVCMOS12 [get_ports {nand_data[12]}]
set_property IOSTANDARD LVCMOS12 [get_ports {nand_data[11]}]
set_property IOSTANDARD LVCMOS12 [get_ports {nand_data[10]}]
set_property IOSTANDARD LVCMOS12 [get_ports {nand_data[9]}]
set_property IOSTANDARD LVCMOS12 [get_ports {nand_data[8]}]
set_property IOSTANDARD LVCMOS12 [get_ports {nand_data[15]}]
set_property DRIVE 8 [get_ports {nand_data[15]}]

set_property PACKAGE_PIN AH3 [get_ports {nand_data[15]}]
set_property PACKAGE_PIN AG3 [get_ports {nand_data[14]}]
set_property PACKAGE_PIN AF3 [get_ports {nand_data[13]}]
set_property PACKAGE_PIN AE3 [get_ports {nand_data[12]}]
set_property PACKAGE_PIN AF2 [get_ports {nand_data[11]}]
