...
--    Note from a humble programmer:
-- 
--    This code has proven to be incredibly (somewhat impressively) unstable, to the point
--    where moving the debug signal to a different place or removing unused states makes
--    things fall apart.
--    
--    Do not touch it. 
-- 
...
--    **************@%#%%%%##%%%%%%%#%%%#%%%##%%%%##%%%%%%#:%#%%%%%#%%%#%***%*************
--    *************@%#%%#%%%##%%#%%%%#%%#%%%%%#%%%%%#%%%%%%:#%##%%%#%%%%@****%************
--    https://images7.memedroid.com/images/UPLOADED181/56e77cc6dbe18.jpeg
